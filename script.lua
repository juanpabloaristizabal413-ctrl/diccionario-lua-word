...
local database = {
    ...
    ["b"] = {"barco", "banana", "banco", "beach", "bebida", "bear", "bicicleta", "beast", "blanco", "beauty", "bosque", "because", "bueno", "become", "balon", "before", "bano", "begin", "barba", "behind", "batalla", "believe", "beso", "better", "boca", "beyond", "brazo", "black", "broma", "blood", "bruja", "board", "buscar", "brain", "buzon", "brave"},
    ["c"] = {"casa", "cabin", "cama", "cable", "cerca", "camera", "cielo", "camp", "clima", "cancer", "comida", "candle", "cuchara", "candy", "caballo", "capital", "cabeza", "captain", "cable", "car", "cadena", "care", "caer", "career", "cafe", "carry", "caja", "catch", "calor", "cause", "calle", "center", "camisa", "certain", "campo", "chair", "cancion", "chance", "carne", "change", "carta", "charge", "coche", "cheap", "color", "check"},
    ...
    ["g"] = {"gato", "game", "gallina", "garden", "gente", "gas", "girar", "general", "globo", "generation", "gota", "girl", "galaxia", "give", "ganar", "glass", "garaje", "go", "garganta", "goal", "gasolina", "good", "gasto", "government", "genio", "great", "gigante", "green", "gloria", "ground", "gobierno", "group", "golpe", "grow", "gordo", "growth", "gracia", "guess", "granja", "guest", "grave", "gun", "grito", "guy", "grupo"},
    ...
    ["i"] = {"ion", "ice", "iones", "idea", "ionizar", "identify", "imagen", "if", "insecto", "illness", "isla", "image", "iglesia", "imagine", "idioma", "important", "iglu", "improve", "igual", "include", "ilegal", "including", "ilusion", "increase", "iman", "indeed", "imitar", "indicate", "imperio", "individual", "impulso", "industry", "incendio", "information", "incluso", "inside", "indio", "instead", "industria", "institution", "infierno", "interest", "informe", "interesting", "inicio", "international", "inmenso", "interview", "inocente", "into", "intento", "investment", "invento", "involve", "invierno", "issue", "ira", "it", "ironia", "item", "izquierdo", "itself"},
    ["j"] = {"juego", "job", "jardin", "join", "jefe", "joke", "jirafa", "journal", "joven", "journey", "jugar", "joy", "jabon", "judge", "jamon", "judgment", "jarra", "juice", "jaula", "jump", "joya", "junior", "judio", "jury", "juez", "just", "jugo", "justice", "juguete", "justify", "juicio", "junta", "jurado", "justicia", "justo", "juventud", "juzgar"},
    ...
    ["m"] = {"mesa", "machine", "mano", "magazine", "metal", "main", "miel", "maintain", "mono", "major", "musica", "majority", "madera", "make", "madre", "man", "maestro", "manage", "magia", "management", "maleta", "manager", "malo", "many", "manzana", "market", "mapa", "marriage", "maquina", "material", "mar", "matter", "marca", "may", "marcha", "maybe", "marido", "me", "mariposa", "mean", "martes", "measure", "masa", "media", "mascota", "medical", "mate", "meet", "materia", "meeting", "mayor", "member", "medicina", "memory", "medico", "mention", "medio", "message", "mente", "method", "mercado", "middle", "mes", "might", "metro", "military", "miedo", "million", "miembro", "mind", "mientras", "minute", "minuto", "miss", "mirar", "mission", "mision", "model", "mitad", "modern", "modelo", "moment", "moderno", "money", "momento", "month", "moneda", "more", "montana", "morning", "moral", "most", "morir", "mother", "motor", "mouth", "mucho", "move", "muerte", "movement", "mujer", "movie", "mundo", "Mr", "muro", "Mrs", "museo", "much", "music", "must", "my", "myself"},
    ["n"] = {"nube", "name", "naranja", "nation", "nieve", "national", "nino", "natural", "noche", "nature", "numero", "near", "nacion", "nearly", "nada", "necessary", "nadar", "need", "nariz", "network", "naturaleza", "never", "nave", "new", "navidad", "news", "necesidad", "newspaper", "negocio", "next", "negro", "nice", "nervio", "night", "nieto", "no", "ninguno", "none", "nivel", "nor", "noble", "north", "nombre", "not", "normal", "note", "norte", "nothing", "nota", "notice", "noticia", "now", "novela", "number", "novia", "novio", "nudo", "nuevo", "nuez", "nunca"},
    ["o"] = {"oro", "occur", "objeto", "ocean", "oceano", "off", "oido", "offer", "oliva", "office", "omega", "officer", "oasis", "official", "obedecer", "often", "obispo", "oh", "obra", "oil", "obrero", "ok", "observar", "old", "obstaculo", "on", "obtener", "once", "ocasion", "one", "oculto", "only", "ocupar", "onto", "ocurrir", "open", "odiar", "operation", "odio", "opportunity", "oeste", "option", "oficina", "or", "oficio", "order", "ofrecer", "organization", "ojo", "other", "ola", "others", "olor", "our", "olvidar", "out", "once", "outside", "onda", "over", "opcion", "own", "operar", "owner", "opinion", "opuesto", "orden", "oreja", "organo", "orgullo", "oriente", "origen", "orilla", "oscuro", "oso", "otono", "oveja"},
    ["p"] = {"perro", "page", "papa", "pain", "pelota", "painting", "pino", "paper", "pozo", "parent", "puerta", "part", "paciencia", "participant", "padre", "particular", "pagar", "particularly", "pagina", "partner", "pais", "party", "palabra", "pass", "palacio", "past", "pan", "patient", "pantalla", "pattern", "papel", "pay", "paquete", "peace", "par", "people", "parar", "per", "pared", "perform", "pareja", "performance", "parque", "perhaps", "parte", "period", "partido", "person", "pasado", "personal", "pasar", "phone", "paso", "physical", "pata", "pick", "paz", "picture", "pecho", "piece", "pedazo", "place", "pedir", "plan", "peligro", "plant", "pelo", "play", "pena", "player", "pensar", "PM", "peor", "point", "pequeno", "police", "perder", "policy", "perdon", "political", "perfecto", "politics", "periodico", "poor", "permiso", "popular", "persona", "population", "peso", "position", "pez", "positive", "pie", "possible", "piedra", "power", "piel", "practice", "pierna", "prepare", "pintura", "present", "piso", "president", "placer", "pressure", "plan", "price", "planta", "private", "plata", "probably", "playa", "problem", "plaza", "process", "plomo", "produce", "pluma", "product", "pobre", "production", "poco", "professional", "poder", "professor", "poema", "program", "policia", "project", "politica", "property", "polvo", "protect", "poner", "prove", "por", "provide", "posible", "public", "precio", "pull", "premio", "purpose", "prensa", "push", "preparar", "put", "primo", "prisa", "problema", "proceso", "pronto", "propio", "prueba", "publico", "pueblo", "puente", "puerto", "punto", "puro"},
