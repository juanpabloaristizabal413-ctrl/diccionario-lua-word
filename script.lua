...
local database = {
    ...
    ["c"] = {"casa", "cabin", "cama", "cable", "cerca", "camera", "cielo", "camp", "clima", "cancer", "comida", "candle", "cuchara", "candy", "caballo", "capital", "cabeza", "captain", "car", "cadena", "care", "caer", "career", "cafe", "carry", "caja", "catch", "calor", "cause", "calle", "center", "camisa", "certain", "campo", "chair", "cancion", "chance", "carne", "change", "carta", "coche", "cheap", "color", "check"},
    ...
    ["i"] = {"ion", "ice", "iones", "idea", "ionizar", "identify", "imagen", "if", "insecto", "illness", "isla", "image", "iglesia", "imagine", "idioma", "important", "iglu", "improve", "igual", "include", "ilegal", "including", "ilusion", "increase", "iman", "indeed", "imitar", "indicate", "imperio", "individual", "impulso", "industry", "incendio", "information", "incluso", "inside", "indio", "instead", "industria", "institution", "infierno", "interest", "interesting", "international", "interview", "inocente", "into", "intento", "investment", "invento", "involve", "invierno", "issue", "ira", "it", "ironia", "item", "izquierdo", "itself"},
    ...
    ["th"] = {"the", "that", "this", "they", "there", "their", "thing", "think", "thought", "through", "those", "these", "than", "then", "theory", "therapy", "therefore", "thick", "thin", "third", "thirsty", "thirty", "threat", "three", "throat", "throw", "thumb", "thunder", "thus", "without", "something", "anything", "nothing", "together", "brother", "mother", "father", "weather", "whether", "although", "rhythm", "sympathy", "healthy", "method"},
    ...
    ["str"] = {"straight", "strange", "stream", "street", "strength", "stress", "strike", "string", "strong", "structure", "strategy", "stretch", "strict", "strip", "stroke", "struggle"},
    ...
    ["pro"] = {"problema", "proceso", "pronto", "propio", "prueba", "producto", "profesor", "programa", "promesa", "probar", "producir", "profesion", "profundo", "progreso", "prohibir", "promedio", "prometer", "propiedad", "proposito", "proteger", "proyecto"},
    ...
    ["st"] = {"stop", "start", "student", "store", "star", "style", "story", "status", "stand", "stone", "study", "strong", "street", "state", "staff", "stage", "step", "stuff", "stable", "standard", "statement", "station", "strategy", "structure", "studio", "stupid", "storm", "strike", "strict", "stream", "stretch", "castle", "mostly", "faster", "master", "estado", "estrella", "estudiar", "estadio", "estacion"},
    ...
    ["to"] = {"todo", "tomate", "tocar", "tono", "today", "tonto", "together", "tormenta", "tonight", "torre", "too", "total", "top", "trabajo", "traer", "tough", "traje", "toward", "trampa", "town", "tranquilo", "trade", "traditional", "training", "travel", "treat", "treatment", "tree", "trial", "trip", "trouble", "true", "truth", "try", "tumor", "turn", "tunel", "TV", "turno", "two", "type"},
    ...
    ["tu"] = {"tuna", "tubo", "tumba", "tumor", "tunel", "turno", "turn", "tube", "tune", "turkey", "turtle"},
    ...
    ["co"] = {"comida", "coche", "color", "como", "comun", "conocer", "conseguir", "consejo", "contacto", "contento", "control", "corazon", "correr", "costa", "costumbre", "coast", "coat", "code", "coffee", "cold", "college", "come", "commercial", "common", "community", "company", "compare", "computer", "condition", "consider", "continue", "cost"},

    -- === LAS 25 COMBINACIONES DIFÍCILES (Anteriores) ===
    ["ms"] = {"hamster", "himself", "themselves", "crimson", "clumsy", "whimsical", "terms", "forms", "arms", "films", "rooms", "items", "atoms", "samsung", "amsterdam", "damsel", "blossoms", "firearms"},
    ["rm"] = {"normal", "hermano", "hermosa", "dormir", "enfermedad", "farmacia", "tormenta", "formacion", "information", "performance", "storm", "warm", "army", "farmer", "formula", "reforma", "permiso", "armadura", "permanente", "supermercado"},
    ["rc"] = {"barco", "cerca", "circo", "marco", "marca", "mercado", "porcentaje", "ejercicio", "parcial", "porcion", "force", "source", "resource", "search", "march", "circle", "commerce", "archivo", "marcar", "percibir"},
    ["tr"] = {"trabajo", "trampa", "triste", "truco", "trato", "trofeo", "estrella", "nuestro", "control", "trouble", "travel", "truth", "strong", "industry", "country", "extreme", "contract", "tradition", "patron", "mientras"},
    ["ct"] = {"acto", "pacto", "efecto", "perfecto", "sector", "directo", "aspecto", "octubre", "doctor", "actor", "factor", "practice", "contact", "connect", "object", "protect", "product", "character", "architecture", "activity"},
    ["gn"] = {"signo", "digno", "ignorar", "magnate", "magnetico", "asignar", "design", "campaign", "foreign", "signal", "signature", "pregnant", "recognize", "champagne", "ignore", "resignation", "cognitive", "dignity", "magnificent"},
    ["pt"] = {"apto", "concepto", "optimista", "capturar", "egipto", "reptil", "eucalipto", "accept", "except", "adopt", "adapt", "empty", "captain", "chapter", "option", "attempt", "symptom", "corrupt", "interrupt", "sculpture"},
    ["mn"] = {"alumno", "columna", "calumnia", "insomnio", "amnistia", "gimnasio", "autumn", "column", "damn", "solemn", "condemn", "hymn", "chimney", "insomnia", "omnipotent", "alumni", "amnesia", "gymnastics"},
    ["mb"] = {"hombre", "nombre", "cambiar", "sombra", "hambre", "sombrero", "tambor", "ambiente", "bomba", "bomb", "climb", "comb", "crumb", "dumb", "remember", "member", "number", "symbol", "cucumber", "plumbing"},
    ["bs"] = {"absoluto", "observar", "obstaculo", "obsesion", "obsoleto", "absorb", "absent", "absolute", "obstacle", "obscure", "obvious", "substance", "subscribe", "subset", "website", "lobster", "substitute", "absence"},
    ["ps"] = {"eclipse", "colapso", "autopsia", "biopsia", "capsula", "collapse", "perhaps", "tips", "steps", "lips", "ships", "crops", "drops", "cups", "shops", "stops", "gypsy", "pepsico", "synapse", "capsule"},
    ...
    ["mp"] = {"tiempo", "campo", "siempre", "comprar", "limpio", "trampa", "romper", "campana", "empanada", "camp", "jump", "lamp", "pump", "simple", "example", "important", "company", "computer", "impossible", "champion"},
    ["nt"] = {"antes", "punto", "cuanto", "dentro", "siento", "cantar", "contar", "tonto", "pintura", "mentira", "want", "went", "plant", "point", "front", "important", "different", "student", "country", "until"},
    ["sp"] = {"despues", "espejo", "esperar", "responder", "chispa", "obispo", "space", "speak", "spend", "sport", "spring", "special", "specific", "speed", "spirit", "hospital", "respect", "crispy", "whisper"},
    ["sc"] = {"disco", "escuela", "oscuro", "buscar", "pescado", "escuchar", "escribir", "asco", "casco", "mosca", "school", "science", "scene", "schedule", "score", "screen", "script", "describe", "discover", "muscle"},
    ["lk"] = {"walk", "talk", "milk", "chalk", "folk", "stalk", "bulk", "sulk", "silk", "elk", "skulk", "balkan", "falkland", "alkali", "milka", "walkway", "talkative", "milking"},
    ["sm"] = {"mismo", "fantasma", "asma", "carisma", "sismo", "entusiasmo", "abismo", "small", "smart", "smile", "smell", "smoke", "smooth", "prism", "sarcasm", "enthusiasm", "spasm", "cosmic", "plasma", "dismal"},
    ["tch"] = {"catch", "match", "watch", "witch", "switch", "kitchen", "stretch", "sketch", "patch", "batch", "fetch", "ditch", "pitch", "butcher", "ketchup", "satchel", "hatchet", "matching"},
    ["squ"] = {"square", "squad", "squash", "squeeze", "squirrel", "squat", "squeak", "squid", "asqueroso", "bosquejo", "esquema", "esquiar", "esquivar", "mezquino", "mosquetero", "pesquisa"},
    ["spl"] = {"splash", "split", "splendid", "splay", "spleen", "splice", "splinter", "display", "esplendor", "esplendido", "desplegar", "desplazar", "displicente", "transplante", "resplandor"},
    ["sch"] = {"school", "scholar", "schedule", "scheme", "schism", "schizophrenia", "schnitzel", "porsche", "bruschetta", "mischief", "schilling", "eschew", "schooner", "schwa"},
    ["chr"] = {"chrome", "chronic", "chronicle", "christ", "christian", "christmas", "chrysalis", "chrysanthemum", "cromo", "cronico", "cronologia", "cristiano", "cristo", "cromosoma", "synchronize"},

    -- === 10 NUEVAS COMBINACIONES "NIVEL DIOS" ===
    ["sph"] = {"sphere", "spherical", "atmosphere", "atmospheric", "hemisphere", "sphinx", "biosphere", "stratosphere", "blasphemy", "phosphor", "atmosfera", "esferico", "estratosfera"},
    ["xcl"] = {"exclude", "excluding", "exclusion", "exclusive", "exclaim", "exclamation", "excluir", "exclusivo", "exclamar", "exclamacion", "excluyente"},
    ["mph"] = {"triumph", "triumphant", "pamphlet", "emphasize", "emphasis", "lymphatic", "amphibian", "nymph", "symphony", "symphonic", "lymphoma", "camphor"},
    ["rst"] = {"first", "thirst", "thirsty", "burst", "worst", "cursed", "understate", "overstep", "interstate", "superstar", "bursty", "wurst"},
    ["nct"] = {"instinct", "distinct", "distinction", "junction", "conjunction", "sanction", "sanctuary", "punctual", "punctuation", "extinct", "extinction", "acupuncture"},
    ["scr"] = {"screen", "script", "screw", "scratch", "scream", "scroll", "scrub", "scramble", "escribir", "escrito", "escritor", "escritura", "describir", "inscripcion"},
    ["mpt"] = {"empty", "attempt", "prompt", "symptom", "exemption", "consumption", "assumption", "preemptive", "temptation", "sumptuous", "redemption", "contempt"},
    ["ctr"] = {"electric", "electrical", "doctrine", "spectrum", "tractor", "destruct", "instruct", "construct", "electrico", "electricidad", "espectro", "destructor", "constructor"},
    ["dge"] = {"edge", "bridge", "judge", "budget", "knowledge", "acknowledge", "fridge", "dodge", "badge", "lodge", "sludge", "ridge"},
    ["mbr"] = {"remember", "member", "membrane", "umbrella", "cambridge", "somber", "hombre", "nombre", "hombro", "sombra", "sombrero", "alambre", "costumbre", "diciembre"}
}
